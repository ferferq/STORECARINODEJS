...
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, createUserUseCase, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        createUserUseCase = tsyringe_1.container.resolve(AuthenticateUserUseCase_1.AuthenticateUserUseCase);
                        return [4 /*yield*/, createUserUseCase.execute({ email: email, password: password })];
                    case 1:
                        data = _b.sent();
