...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var password, email, emailAlreadyExists, passwordHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.userRepository.create(__assign(__assign({}, user), { password: passwordHash }))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
