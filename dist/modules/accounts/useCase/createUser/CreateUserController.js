...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, name, driver_license, password, createUserUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, email = _a.email, name = _a.name, driver_license = _a.driver_license, password = _a.password;
                        createUserUseCase = tsyringe_1.container.resolve(CreateUserUseCase_1.CreateUserUseCase);
                        return [4 /*yield*/, createUserUseCase.execute({ email: email, name: name, driver_license: driver_license, password: password })];
                    case 1:
                        _b.sent();
